 ...
 *              Uses @react-native-ml-kit/face-detection via periodic camera snapshots
 *              (replaces deprecated expo-face-detector onFacesDetected callback).
 *
 *   Detection loop:
...
const FaceEnrollScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      {/* Camera — no onFacesDetected or faceDetectorSettings (ML Kit handles it) */}
